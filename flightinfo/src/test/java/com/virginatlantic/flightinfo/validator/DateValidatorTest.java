...
public class DateValidatorTest {
    ...
    void shouldReturnTrueForValidDate() {
        ...
        Assertions.assertTrue(DateValidator.isValidDate(date, ApplicationConstants.DATEFORMAT));
    ...
    void shouldReturnFalseForInValidDate() {
        ...
        Assertions.assertFalse(DateValidator.isValidDate(date, ApplicationConstants.DATEFORMAT));
    }
}
